...
<html>
    ...
    <body>
        ...
        <div class="form-container">
            ...
            <form:form method="PUT" modelAttribute="upload" enctype="multipart/form-data" class="form-horizontal">
                <div class="row">
                    <div class="form-group col-md-12">     
                        <div class="col-md-7">
                            <form:label class="col-md-5 control-label" path="video" for="file">Upload a Video!</form:label>
                            <form:input type="file" path="video" id="file" class="help-inline col-md-offest-6"/>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <form:input type="text" path="title" id="title" class="help-inline col-md-6"/>     
                     </div> <!-- End class form-group-->
                </div> <!-- End class row-->
